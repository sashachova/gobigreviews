...
namespace Gobigreviews.Tests
{
    public class SignUpTests
    {
        ...
        public void SignUp_RegistrationFormIsDisplayed()
        {
            ...
            //TO-DO verify placeholder
            Assert.That(SignUp.IsPasswordDisplayed(), "Password field is not displayed");
            //TO-DO verify placeholder
            Assert.That(SignUp.IsRepeatPasswordDisplayed(), "Repeate password field is not displayed");
            //TO-DO verify placeholder
        ...
        //To-Do add test case with user data in [Test]
